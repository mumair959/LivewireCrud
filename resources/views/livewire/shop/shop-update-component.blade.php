        ...
        <div class="container">
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="sh-email" wire:model="email" placeholder="{{__('Enter Email Address')}}" disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4" wire:ignore>
                    ...
                    <select class="form-select" id="select2-categories" wire:model="category_ids" data-placeholder="{{__('Select Product Categories')}}" multiple="multiple">
